package com.ua.jelrus.chat_bot_app.config;
...
@Configuration
@EnableJpaRepositories("com.ua.jelrus.chat_bot_app.persistence.repository")
public class HibernateConfig {
    ...
    private static final String ENTITY_MANAGER_PACKAGES_TO_SCAN = "com.ua.jelrus";
